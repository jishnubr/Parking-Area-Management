...
<?php
	...
	$query=mysql_query("SELECT * FROM `two_wheelers_slot`");
	echo mysql_error();
?>
<body>
<center>
<h2>Remaining slots on  two wheeler</h2></center><right>
<a href='everyone.php?tag=view_Two%20Wheelers' /><input type="button"  value="GO BACK"/></a>
</right>
<center>
<table>
 <tbody>
