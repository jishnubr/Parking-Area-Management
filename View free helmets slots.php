...
<?php
	...
	$query=mysql_query("SELECT * FROM `helmets_slot`");
	echo mysql_error();
?>
<body>
<center>
<h2>Remaining slots on helmets</h2></center><right>
<a href='everyone.php?tag=view_Helmets' /><input type="button"  value="GO BACK"/></a>
</right>
<center>
<table>
 <tbody>
