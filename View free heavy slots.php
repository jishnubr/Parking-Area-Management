...
<?php
	...
	$query=mysql_query("SELECT * FROM `heavy_slots`");
	echo mysql_error();
?>
<body>
<center>
<h2>Remaining slots on heavy vehicle</h2></center><right>
<a href='everyone.php?tag=view_Heavy%20Vehicles' /><input type="button"  value="GO BACK"/></a>
</right>
<center>
<table>
 <tbody>
